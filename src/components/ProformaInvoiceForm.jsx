...
IBAN :TR29 0003 2000 0320 0000 9679 79`
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Form data ve goods verilerini birleştir - sadece formData gönder
      const combinedData = {
        ...formData,
        goods: goods
      };
      ...
      const response = await generatePDF(combinedData, 'proforma-invoice', selectedLanguage);
      ...
      if (response) {
        ...
        // Dosya adını RECIPIENT Şirket Adı ile oluştur
        ...
        link.download = `${safeCompanyName}_Proforma-Invoice.pdf`;
